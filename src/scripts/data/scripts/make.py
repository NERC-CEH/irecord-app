...
_json_translator.run('list.csv', output_filename + '.json')

# Create common name map
print('Building name map...')
subprocess.call('node --harmony scripts/_makeCommonNameMap.js ../' + output_filename + '.json names_' + output_filename + '.json', shell=True)
