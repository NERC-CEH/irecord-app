<ul class="table-view accordion" id="accordion">
  ...
  <li class="table-view-cell">
    ...
    <p id="c1" class="collapse"
      ...
      Once picked a photo, the app will create a new record without any species associated to it.
      ...
      open the record (either by opening it directly from taxa search page or through
      home-list page) and fill in the details of the sighting, like location, date, number seen etc.
      <br>
      <br>
      When finished, press a paperplane <span class="icon icon-send"></span> button (top-right).
    </p>
  </li>
  <li class="table-view-cell">
    <a class="collapsed" data-toggle="collapse" data-parent="#accordion"
    ...
    <p id="c2" class="collapse"
       aria-labelledby="headingOne" aria-expanded="false">
      The application holds all of UK's species (70000+) and all the associated taxonomy ranks.
  ...
  <li class="table-view-cell">
    ...
    <p id="c3" class="collapse"
      ...
      While it is in the <i>draft</i> mode the application will not synchronise
      your record with the database. To flag a record for sending,
  ...
  <li class="table-view-cell">
    ...
    <p id="c5" class="collapse"
      ...
      <br><br>
      You can also delete all the records that have been successfully synchronised
  ...
  <li class="table-view-cell">
    ...
    <p id="c7" class="collapse"
       aria-labelledby="headingTwo" aria-expanded="false">
      You can manage your saved locations both on any record's location page and
