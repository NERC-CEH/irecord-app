  ...
  <ul className="table-view">
    <li>
      ...
      <p>
        ...
        </a>. This enables you to log in and see your records and those
        submitted by other people for all species. Your name, as specified when
        you create the account, will appear next to your records and will be
    ...
    <li>
      ...
      <p>
        ...
        will not be shown and disseminated with your records but will be
        available to the verifying experts if they need to contact you about
        your sightings. You are able to delete your iRecord account or opt out
        of receiving emails at any time.
      </p>
    </li>
    <li>
      <p>
    ...
    <li>
      ...
      <p>
        ...
        recording scheme or verifying records as experts, will have access to
        your email address. Unless required by law, data will not be made
        available to any third parties unless we have obtained your permission
        to do so.
      </p>
    </li>
    <li>
      ...
      <ul>
        <li>
          <p>
            ...
            on their respective websites and to use the file/s in any publicity
