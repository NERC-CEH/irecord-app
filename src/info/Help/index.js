    ...
    <ion-list lines="full">
      ...
      <Collapse title={t('How to make a new record')}>
        <p>
          ...
          <br />
          {t('Press the camera button')} <Icon i="camera" />{' '}
          {t(
          ...
          <br />
          {t('Please press the plus')} <Icon i="plus" />{' '}
          {t(
      ...
      <Collapse title={t('Sync. with iRecord')}>
        <p>
          ...
          {t('set for submission & saved locally')}) {t('will become green')}{' '}
      ...
      <Collapse title={t('Send all records')}>
        <p>
          ...
          <Icon i="settings" /> {t('and click Submit All')}
          <Icon i="send" /> {t('button')}.{' '}
      ...
      <Collapse title={t('Delete a record')}>
        <p>
          ...
          <Icon i="settings" /> {t('and click')} {t('Remove All Saved')}
          <Icon i="delete" /> {t('button')}.
        </p>
      </Collapse>
      ...
      <Collapse title={t('Sign in/out or register')}>
        <p>
          {t('To login, open the main menu page')} <Icon i="menu" />,
          {t('click Login')} <Icon i="user" />
          {t('or Register')} <Icon i="user-plus" />
          {t('buttons and follow the instructions')}.
          <br />
          <br />
          {t('To logout, visit the main menu page')} <Icon i="menu" />
          {t('and click the logout')} <Icon i="logout" /> {t('button')}.
          <br />
          <br />
          <b>{t('Note')}:</b>{' '}
          {t(
      ...
      <Collapse title={t('Manage saved locations')}>
        <p>
          ...
          <Icon i="settings" />. {t('Swipe a location left and click edit')}
          <Icon i="edit" /> {t('or delete')}
          <Icon i="delete" /> {t('buttons')}.
          <br />
          <br />
      ...
      <Collapse title={t('Reset the application')}>
        <p>
          {t('Go to the application settings page')} <Icon i="settings" />{' '}
          {t('and click on the Reset')} <Icon i="undo" />
          {t('button')}.
        </p>
      </Collapse>
      <ion-item>
