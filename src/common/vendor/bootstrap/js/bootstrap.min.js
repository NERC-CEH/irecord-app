      ...
      (i.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (p) {
            ...
            (a =
              'bottom' == a && h.bottom + d > u.bottom
                ? 'top'
                : 'top' == a && h.top - d < u.top
                  ? 'bottom'
                  : 'right' == a && h.right + c > u.width
                    ? 'left'
                    : 'left' == a && h.left - c < u.left ? 'right' : a),
              s.removeClass(f).addClass(a);
          }
          var g = this.getCalculatedOffset(a, h, c, d);
